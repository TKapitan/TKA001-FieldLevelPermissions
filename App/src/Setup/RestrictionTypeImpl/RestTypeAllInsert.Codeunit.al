/// <summary>
/// Codeunit TKA Rest. Type-All.Insert (ID 89002) implements Interface TKA Restriction Type.
/// </summary>
codeunit 89002 "TKA Rest. Type-All.Insert" implements "TKA Restriction Type"
{
    /// <summary>
    ...
    begin
        if (ActionType = ActionType::Insert) or (Format(xFieldRef.Value()) = '') then
            exit(false);
        exit(true);
    end;
}